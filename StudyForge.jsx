...
.sf .cap-1{ top:33%; left:38%; } .sf .cap-2{ bottom:31%; left:56%; } .sf .cap-3{ top:63%; left:87%; }
...
.sf .fr-a{ top:15%; left:4%; width:152px; height:210px; animation:driftE 13s ease-in-out infinite; }
.sf .fr-b{ bottom:13%; left:17%; width:158px; height:158px; animation:driftF 15s ease-in-out infinite; }
.sf .fr-c{ top:45%; left:64%; width:230px; height:146px; animation:driftG 12s ease-in-out infinite; }
.sf .fr-d{ top:9%; left:67%; width:120px; height:120px; animation:driftH 16s ease-in-out infinite; }
...
.sf .fc-a{ top:12%; left:45%; width:248px; animation:driftA 11s ease-in-out infinite; }
.sf .fc-b{ bottom:12%; left:76%; width:236px; animation:driftB 13s ease-in-out infinite; }
.sf .fc-c{ top:7%; left:82%; width:210px; animation:driftC 12s ease-in-out infinite; }
.sf .fc-d{ bottom:21%; left:47%; width:202px; animation:driftD 14s ease-in-out infinite; }
