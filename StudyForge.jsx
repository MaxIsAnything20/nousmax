        ...
        <>
          <div className="pin center">
            <div style={{ maxWidth: 780, margin: "0 auto" }}>
              ...
              <p className="rise d2" style={{ fontSize: "clamp(16px,2.2vw,19px)", color: "var(--muted)", lineHeight: 1.6, maxWidth: 560, margin: "0 auto 30px" }}>
              ...
              <div className="rise d4" style={{ marginTop: 46 }}>
                <QuestionCard />
