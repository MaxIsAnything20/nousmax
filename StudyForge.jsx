...
.sf .intro-morph.play .nmw .g{ animation:writeLtr .95s cubic-bezier(.22,1,.34,1) forwards; }
.sf .intro-morph.play .nmw > span:nth-child(2){ animation-delay:0s; }
.sf .intro-morph.play .nmw > span:nth-child(3){ animation-delay:.13s; }
.sf .intro-morph.play .nmw > span:nth-child(4){ animation-delay:.26s; }
.sf .intro-morph.play .nmw > span:nth-child(6){ animation-delay:.39s; }
.sf .intro-morph.play .nmw > span:nth-child(7){ animation-delay:.52s; }
@keyframes writeLtr{
