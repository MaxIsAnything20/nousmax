...
.sf .hero-art{ position:absolute; inset:0; pointer-events:none; z-index:1; overflow:hidden; }
...
.sf .vl-1{ left:31%; } .sf .vl-2{ left:56%; } .sf .vl-3{ left:79%; }
...
.sf .cap{ position:absolute; font-family:Georgia,'Times New Roman',serif; font-style:italic;
  font-size:15px; letter-spacing:.42em; text-transform:uppercase; color:var(--cream-muted);
  white-space:nowrap; opacity:0; }
.sf .cap-1{ top:31%; left:41%; } .sf .cap-2{ bottom:30%; left:62%; } .sf .cap-3{ top:66%; left:81%; }
.sf.nav-up .cap-1{ animation:capCyc 16s ease-in-out .8s infinite; }
.sf.nav-up .cap-2{ animation:capCyc 16s ease-in-out 6.1s infinite; }
.sf.nav-up .cap-3{ animation:capCyc 16s ease-in-out 11.4s infinite; }
...
.sf .frame{ position:absolute; border:1px solid rgba(28,27,35,.11); border-radius:10px;
  background:linear-gradient(145deg,#efece4 0%,#e4dfd3 55%,#d7d1c3 100%);
  box-shadow:0 26px 52px -30px rgba(40,25,90,.3); opacity:0; transition:opacity 1.2s ease; }
.sf .frame::after{ content:""; position:absolute; inset:8px; border:1px solid rgba(28,27,35,.06); border-radius:5px; }
.sf .fr-a{ top:14%; left:5%; width:150px; height:208px; animation:driftE 13s ease-in-out infinite; }
.sf .fr-b{ bottom:15%; left:20%; width:158px; height:158px; animation:driftF 15s ease-in-out infinite; }
.sf .fr-c{ top:45%; left:49%; width:232px; height:146px; animation:driftG 12s ease-in-out infinite; }
.sf .fr-d{ top:9%; left:83%; width:122px; height:122px; animation:driftH 16s ease-in-out infinite; }
...
.sf .fc-a{ top:13%; left:52%; width:248px; animation:driftA 11s ease-in-out infinite; }
.sf .fc-b{ bottom:10%; left:75%; width:236px; animation:driftB 13s ease-in-out infinite; }
.sf .fc-c{ top:5%; left:67%; width:210px; animation:driftC 12s ease-in-out infinite; }
.sf .fc-d{ bottom:25%; left:58%; width:202px; animation:driftD 14s ease-in-out infinite; }
        ...
        <>
          <div className="pin hero-left">
            ...
            <div className="hero-art" aria-hidden="true">
              ...
              <span className="cap cap-1">recall</span>
              <span className="cap cap-2">focus</span>
              <span className="cap cap-3">remember</span>
