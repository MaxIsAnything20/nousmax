...
.sf .authcard{ position:fixed; z-index:121; top:50%; left:50%; transform:translate(-50%,-50%);
  width:404px; max-width:calc(100vw - 32px); border-radius:20px; padding:34px 30px; }
...
function AuthModal({ mode, setMode, onClose, onAuthed }) {
  ...
  return (
    <>
      <div className="tour-mask" style={{ zIndex: 120 }} onClick={onClose} />
      <div className="authcard glassx hud pop-in">
