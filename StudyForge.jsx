...
.sf{ --bg:#0a0c13; --bg2:#0f121c; --surface:#141826; --surface2:#1b2032;
  ...
  --amber:#f5c451; --amber2:#fcd77a; --cream:#f4f1ea; --cream-ink:#1b1b24; --cream-muted:#5c5c68;
  color-scheme:dark;
}
.sf.light{ --bg:#f6f7fc; --bg2:#eceffa; --surface:#ffffff; --surface2:#f4f6fd;
  ...
  --shadow:0 24px 60px -28px rgba(30,30,80,.35);
  --amber:#d99a1f; --amber2:#eab543; --cream:#efece4; --cream-ink:#1b1b24; --cream-muted:#5c5c68;
  color-scheme:light;
}
...
.sf .fbadge{ position:absolute; top:-9px; right:-9px; width:26px; height:26px; border-radius:99px;
  background:var(--amber); color:#241a00; font-size:13px; font-weight:850; display:grid; place-items:center;
  box-shadow:0 6px 14px -4px rgba(245,196,81,.6); }
...
function FullPage({ theme, toggleTheme, onStart, pages, labels }) {
      ...
      <div className="lnav">
        <div className="lnav-in">
          ...
          <div className="row gap12">
            ...
            <button className="signin" onClick={onStart}>Sign in</button>
          </div>
        </div>
      </div>
...
function Landing({ onStart, theme, toggleTheme }) {
  ...
  return (
    <FullPage theme={theme} toggleTheme={toggleTheme} onStart={onStart}
