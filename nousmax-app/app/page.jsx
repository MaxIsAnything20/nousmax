...
export default function Page() {
  ...
  return (
    <div className="wrap">
      <div className="brand">
        <span>Nous<span className="m">Max</span></span>
      </div>
      <h1>Turn any notes into a <span className="amber">study set.</span></h1>
      ...
      <div className="row">
        ...
        <span style={{ color: "var(--cream-muted)", fontSize: 13 }}>{text.length} characters</span>
      </div>
